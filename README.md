...
- Make the touch more responsive by allowing the CPU to act faster even with the lightest touches, favoring the responsiveness of the UX, after all we already know that the task will finish faster and will allow the CPU to rest after simple touches.
