...
- Follow a more opportunistic refresh rate scheduler. Allow the screen to enter high performance as soon as the user starts activity, and when there is no more, it opportunistically enters idle. Based on this, even the screen refresh rate is included in our "rice-to-idle" strategy.
